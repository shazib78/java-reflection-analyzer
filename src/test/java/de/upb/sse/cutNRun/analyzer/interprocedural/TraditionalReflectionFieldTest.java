...
public class TraditionalReflectionFieldTest {
    ...
    //TODO: string concat logic not written
   /* @Test
    ...
    public void shouldAnalyzeFile6() {
        View view = new JavaView(new JavaClassPathAnalysisInputLocation("src/test/resources/interprocedural/field/File6-interface"));
